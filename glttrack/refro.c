#include "slalib.h"
#include "slamac.h"
static void atmt ( double r, double *t, double *dn, double *rdndr );
static void atms ( double r, double *dn, double *rdndr );

/*--------------------------------------------------------------------------*/

/* Variables shared between slaRefro and the internal routine atmt */
static double robs;   /* height of observer from centre of Earth (metre) */
static double tdkok;  /* temperature at the observer (deg K) */
static double alpha;  /* alpha          |        */
static double gamm2;  /* gamma minus 2  | see ES */
static double delm2;  /* delta minus 2  |        */
static double c1,c2,c3,c4,c5,c6;  /* various */

/* Variables shared between slaRefro and the internal routine atms */
static double rt;     /* height of tropopause from centre of Earth (metre) */
static double tt;     /* temperature at the tropopause (deg k) */
static double dnt;    /* refractive index at the tropopause */
static double gamal;  /* constant of the atmospheric model = g*md/r */
...
**
**  Last revision:   13 November 1995
**
