...
*/
	...
	del= reldc + relsag*cose + relsagsin*sine + relsagtan*sine/cose + reaztilt_sin*cosa + reaztilt_cos*sina +reaztilt_sin2*cos2a +reaztilt_cos2*sin2a;
/*
...
*/
	...
	del= eldc + elsag*cose + elsagsin*sine + elsagtan*sine/cose + eaztilt_sin*cosa + eaztilt_cos*sina +eaztilt_sin2*cos2a +eaztilt_cos2*sin2a;
