...
pthread_t	CommandHandlerTID, ACUstatusTID ;
...
/*
	dsm_status=dsm_write(DSM_HOST,"DSM_ACTUAL_AZ_DEG_D",&az_actual_corrected_rm);
	dsm_status=dsm_write(DSM_HOST,"DSM_ACTUAL_EL_DEG_D",&el_actual_disp_rm);
*/
